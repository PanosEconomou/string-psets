...
Notice that we can combine the fundamental $\mathbf{10}$ of $SO(10)$ with the fundamental $\overline{\mathbf{16}}$ of $SO(10)$ to build a fundamental representation of $E_6$ given by $\overline{\mathbf{27}} \cong \mathbf{10} \oplus \overline{\mathbf{16}}$. A summary of these results is in Table~\ref{tab:twisted}. Finally an identical analysis shows that the $r^2$ twisted sectors simply give antiparticles to these.
