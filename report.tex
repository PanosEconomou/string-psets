...
\begin{table}
    ...
    \hline\hline
    $r$ & {Right Massless } & Left Massless\\
    \hline
    \multirow{2}{1em}{$1$}           & $\mathbf{8}				\otimes \mathbf{1}				\otimes \mathbf{1}$
