...
\begin{align*}
	\text{tr\,} q^{L_0} \bar q^{\tilde L_0}\xRightarrow{\tau \mapsto \tau+1} \text{tr\,} e^{2\pi i (L_0 - \tilde L_0)}q^{L_0} \bar q^{\tilde L_0}.
\end{align*}
...
$\rightarrow$ Explain why we expect that only one spacetime $d=4$ supersymmetry should be present and be spontaneously broken in the weak scale, and use this to motivate the oribifold that we took.
\end{document}
